 ...
 * description file
 */
class VirtualKeyboardParser: public XmlReader
{
...
protected:
  ...
  bool parserCallback_keyboard(const xmlNode *node);
  bool parserCallback_mode(const xmlNode *node);
  bool parserCallback_event(const xmlNode *node);
  bool parserCallback_layout(const xmlNode *node);
  bool parserCallback_map(const xmlNode *node);
