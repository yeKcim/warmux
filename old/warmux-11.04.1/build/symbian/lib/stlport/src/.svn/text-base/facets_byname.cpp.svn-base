...
_Messages_impl::_Messages_impl(bool is_wide, _Locale_name_hint* hint) :
  ...
  _M_delete = true;
  if (is_wide)
    _M_map = _CHECK_PTR(new _Catalog_locale_map);
...
messages<char>::messages(size_t refs) :
  locale::facet(refs), _M_impl(_CHECK_PTR(new _STLP_PRIV _Messages_impl(false))) {}

messages<char>::messages(size_t refs, _Locale_messages* msg_obj) : locale::facet(refs),
  _M_impl(_CHECK_PTR(new _STLP_PRIV _Messages_impl(false, msg_obj))) {}
...
messages<wchar_t>::messages(size_t refs)  :
  locale::facet(refs), _M_impl(_CHECK_PTR(new _STLP_PRIV _Messages_impl(true))) {}

messages<wchar_t>::messages(size_t refs, _Locale_messages* msg_obj)
  : locale::facet(refs),
    _M_impl(_CHECK_PTR(new _STLP_PRIV _Messages_impl(true, msg_obj))) {}
