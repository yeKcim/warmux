/*
 * libxml2_chvalid.c:   this module implements the character range
 *                      validation APIs
 *
...
/*
 =====================================================================================
        GLOBAL CONSTANTS (moved from _xmlGlobalState struct)
 =====================================================================================
*/
XMLPUBFUNEXPORT const xmlChSRange  xmlIsBaseChar_srng[197] = { {0x100, 0x131}, {0x134, 0x13e},
...
XMLPUBFUNEXPORT const xmlChRangeGroup xmlIsBaseCharGroup =
    {197, 0, xmlIsBaseChar_srng, (xmlChLRangePtr)0};

XMLPUBFUNEXPORT const xmlChSRange xmlIsCombining_srng[] = { {0x300, 0x345},
...
XMLPUBFUNEXPORT const xmlChRangeGroup xmlIsDigitGroup =
    {14, 0, xmlIsDigit_srng, (xmlChLRangePtr)0};

XMLPUBFUNEXPORT const xmlChSRange xmlIsExtender_srng[] = { {0x2d0, 0x2d0}, {0x2d1, 0x2d1},
    {0x387, 0x387}, {0x640, 0x640}, {0xe46, 0xe46}, {0xec6, 0xec6},
    {0x3005, 0x3005}, {0x3031, 0x3035}, {0x309d, 0x309e}, {0x30fc, 0x30fe}};

XMLPUBFUNEXPORT const xmlChRangeGroup xmlIsExtenderGroup =
 ...
 *
 */
XMLPUBFUNEXPORT const unsigned char xmlIsPubidChar_tab[256] = {
