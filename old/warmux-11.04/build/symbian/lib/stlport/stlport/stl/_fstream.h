...
#if defined (_STLP_UNIX) || defined (_STLP_MAC) || defined (__SYMBIAN32__)
...
struct _Filebuf_Tmp_Buf {
  _CharT* _M_ptr;
  _Filebuf_Tmp_Buf(ptrdiff_t __n) : _M_ptr(0) { _M_ptr = _CHECK_PTR(new _CharT[__n]); }
