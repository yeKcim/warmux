...
locale::locale(const char* name)
  ...
  _Locale_impl* impl = 0;
  _STLP_TRY {
    impl = _CHECK_PTR(new _Locale_impl(locale::id::_S_max, name));
...
locale::locale(const locale& L, const char* name, locale::category c)
  ...
  _STLP_TRY {
    impl = _CHECK_PTR(new _Locale_impl(*L._M_impl));
...
locale::locale(const locale& L1, const locale& L2, category c)
  : _M_impl(0) {
  _Locale_impl* impl = _CHECK_PTR(new _Locale_impl(*L1._M_impl));
